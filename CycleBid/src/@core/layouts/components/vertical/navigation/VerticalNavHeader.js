  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          <Box sx={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center", display: navCollapsed && !navHover ? 'none' : 'block',paddingTop: 4}}>
              <img alt='error-illustration' src='/images/logos/cyclebid-logo.svg' Width='130'height='50' />
              </Box>
