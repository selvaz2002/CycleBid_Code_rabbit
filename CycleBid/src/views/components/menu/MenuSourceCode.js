export const MenuBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const MenuCompositionJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const MenuContextJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const MenuCustomizedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const MenuMaxHeightJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const MenuSelectedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const MenuTransitionJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
