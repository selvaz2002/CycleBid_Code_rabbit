export const BadgesAlignmentJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const BadgesBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Badge from '@mui/material/Badge'
import Avatar from '@mui/material/Avatar'
...
export const BadgesLightJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Avatar from '@mui/material/Avatar'
...
export const BadgesOverlapJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Badge from '@mui/material/Badge'
import Avatar from '@mui/material/Avatar'
import { styled } from '@mui/material/styles'
...
export const BadgesDotJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Badge from '@mui/material/Badge'
import Avatar from '@mui/material/Avatar'
...
export const BadgesMaxValueJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Badge from '@mui/material/Badge'
import Avatar from '@mui/material/Avatar'
import { styled } from '@mui/material/styles'
...
export const BadgesVisibilityJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
