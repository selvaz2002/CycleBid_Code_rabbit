export const SnackbarAlertJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const SnackbarControlSlideDirectionJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { Fragment, useState } from 'react'
...
export const SnackbarConsecutiveJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const SnackbarSimpleJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { Fragment, useState } from 'react'
...
export const SnackbarPositionedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { Fragment, useState } from 'react'
...
export const SnackbarTransitionJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { Fragment, useState } from 'react'
