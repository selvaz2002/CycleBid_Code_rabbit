export const RatingsSizesJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const RatingsHalfJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
import Rating from '@mui/material/Rating'
...
export const RatingsHoverFeedbackJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const RatingsCustomizedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
import Typography from '@mui/material/Typography'
import Rating from '@mui/material/Rating'
...
export const RatingsBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
