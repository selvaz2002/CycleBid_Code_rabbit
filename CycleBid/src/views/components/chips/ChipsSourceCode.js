export const ChipsAvatarJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const ChipsArrayJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const ChipsClickableJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Chip from '@mui/material/Chip'
...
export const ChipsDisabledJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Chip from '@mui/material/Chip'
...
export const ChipsLightJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const ChipsColorsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const ChipsIconJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Chip from '@mui/material/Chip'
...
export const ChipsSizesJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Chip from '@mui/material/Chip'
...
export const ChipsVariantsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Chip from '@mui/material/Chip'
...
export const ChipsRoundedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import CustomChip from 'src/@core/components/mui/chip'
...
export const ChipsOnDeleteJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { Fragment } from 'react'
