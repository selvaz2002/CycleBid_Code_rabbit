export const AccordionControlledJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const AccordionCustomizedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const AccordionActionsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const AccordionSimpleJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Accordion from '@mui/material/Accordion'
import Typography from '@mui/material/Typography'
import AccordionSummary from '@mui/material/AccordionSummary'
import AccordionDetails from '@mui/material/AccordionDetails'
