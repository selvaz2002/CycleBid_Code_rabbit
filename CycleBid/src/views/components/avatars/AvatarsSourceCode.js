export const AvatarsGroupedPullUpJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const AvatarsGroupedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Avatar from '@mui/material/Avatar'
import AvatarGroup from '@mui/material/AvatarGroup'
...
export const AvatarsGroupedPullUpWithTooltipJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Avatar from '@mui/material/Avatar'
...
export const AvatarsIconJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const AvatarsLetterJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
...
export const AvatarsSizesJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
import Avatar from '@mui/material/Avatar'
...
export const AvatarsVariantsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
...
export const AvatarsImageJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
import Avatar from '@mui/material/Avatar'
...
export const AvatarsWithBadgeJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
