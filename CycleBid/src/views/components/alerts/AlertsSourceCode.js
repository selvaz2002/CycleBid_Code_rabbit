export const AlertsActionsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const AlertsDescriptionJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Alert from '@mui/material/Alert'
...
export const AlertsBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Alert from '@mui/material/Alert'
...
export const AlertsDismissibleJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{` 
...
export const AlertsFilledJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Alert from '@mui/material/Alert'
...
export const AlertsOutlinedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Alert from '@mui/material/Alert'
