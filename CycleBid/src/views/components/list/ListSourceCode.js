export const ListProgressJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const ListStickySubheaderJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
import List from '@mui/material/List'
import ListItem from '@mui/material/ListItem'
import ListItemText from '@mui/material/ListItemText'
...
export const ListSimpleJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const ListDenseJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { Fragment } from 'react'
...
export const ListItemSelectedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const ListSecondaryJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import List from '@mui/material/List'
import Avatar from '@mui/material/Avatar'
import ListItem from '@mui/material/ListItem'
import IconButton from '@mui/material/IconButton'
...
export const ListUsersJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
import Avatar from '@mui/material/Avatar'
...
export const ListWithCheckboxJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const ListWithSwitchJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const ListNestedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
