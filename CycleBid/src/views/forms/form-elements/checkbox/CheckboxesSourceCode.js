export const CheckboxesBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const CheckboxesColorsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Checkbox from '@mui/material/Checkbox'
import FormGroup from '@mui/material/FormGroup'
import FormControlLabel from '@mui/material/FormControlLabel'
...
export const CheckboxesCustomIconsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Checkbox from '@mui/material/Checkbox'
import FormGroup from '@mui/material/FormGroup'
import FormControlLabel from '@mui/material/FormControlLabel'
...
export const CheckboxesCustomizedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const CheckboxesShowErrorJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const CheckboxesSizesJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Checkbox from '@mui/material/Checkbox'
import FormGroup from '@mui/material/FormGroup'
import FormControlLabel from '@mui/material/FormControlLabel'
...
export const CheckboxesControlledUncontrolledJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const CheckboxesLabelPlacementJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Checkbox from '@mui/material/Checkbox'
import FormGroup from '@mui/material/FormGroup'
import FormControlLabel from '@mui/material/FormControlLabel'
