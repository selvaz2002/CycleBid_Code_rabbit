export const SwitchesLabelPlacementJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const SwitchesCustomizedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Switch from '@mui/material/Switch'
...
export const SwitchesControlledUncontrolledJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const SwitchesBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Switch from '@mui/material/Switch'
import FormGroup from '@mui/material/FormGroup'
import FormControlLabel from '@mui/material/FormControlLabel'
...
export const SwitchesStandaloneJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Switch from '@mui/material/Switch'
...
export const SwitchesColorsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Switch from '@mui/material/Switch'
import FormGroup from '@mui/material/FormGroup'
import FormControlLabel from '@mui/material/FormControlLabel'
...
export const SwitchesSizesJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Switch from '@mui/material/Switch'
import FormGroup from '@mui/material/FormGroup'
import FormControlLabel from '@mui/material/FormControlLabel'
