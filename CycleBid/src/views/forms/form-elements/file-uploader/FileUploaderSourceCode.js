export const FileUploaderMultipleJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const FileUploaderRestrictionsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { Fragment, useState } from 'react'
...
export const FileUploaderSingleJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
