export const CustomCheckboxBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const CustomCheckboxIconsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const CustomCheckboxImgJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const CustomRadioIconsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const CustomRadioBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const CustomRadioImgJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
