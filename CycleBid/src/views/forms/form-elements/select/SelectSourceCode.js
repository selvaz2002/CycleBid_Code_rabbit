export const SelectGroupingJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const SelectCustomizedJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const SelectMultipleJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const SelectControlledUncontrolledJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const SelectNativeJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Select from '@mui/material/Select'
import InputLabel from '@mui/material/InputLabel'
import FormControl from '@mui/material/FormControl'
...
export const SelectWithDialogJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import { useState } from 'react'
...
export const SelectVariantsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Select from '@mui/material/Select'
import MenuItem from '@mui/material/MenuItem'
import InputLabel from '@mui/material/InputLabel'
import FormControl from '@mui/material/FormControl'
...
export const SelectPropsJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
import Box from '@mui/material/Box'
import Select from '@mui/material/Select'
import MenuItem from '@mui/material/MenuItem'
import InputLabel from '@mui/material/InputLabel'
