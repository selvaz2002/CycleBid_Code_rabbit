export const TextareaBasicJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
...
export const TextareaVariantJSXCode = (<pre className='language-jsx'><code className='language-jsx'>{`
