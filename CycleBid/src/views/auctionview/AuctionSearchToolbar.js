...
const AuctionSearchToolbar = props => {
  ...
  return (
    ...
    >
      ...
      <ClickAwayListener
        onClickAway={() => {
          setShowDatePicker(false), setAnchorEl1(null)
        }}
      >
        <Box sx={{}}>
          <TextField
          ...
          <Menu anchorEl={anchorEl1} open={Boolean(anchorEl1)} onClose={() => setAnchorEl1(null)}>
            {options.map(option => (
              <MenuItem
                ...
                sx={{
                  backgroundColor:
                    selectedOption === option.label ? lighten(theme.palette.primary.main, 0.7) : 'transparent'
                }}
              >
                <ListItemText>
                  <Typography
                    sx={{ color: selectedOption === option.label ? theme.palette.primary.main : 'primary.secondary' }}
                  >
                    {option.label}
                  </Typography>
                </ListItemText>
...
export default AuctionSearchToolbar
