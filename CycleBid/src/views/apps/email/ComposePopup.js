  ...
  return (
    <Drawer
      ...
      sx={{
        ...
        '& .MuiDrawer-paper': {
          borderRadius: 1,
          position: 'static',
          width: { xs: composePopupWidth, md: '700px', lg: '750px' },
    ...
    >
      ...
      >
        ...
        <Typography sx={{ color: 'text.secondary' ,display:{xs:"flex",md:"inline"},flexWrap:{xs:"wrap",md:"normal"},flexDirection:{xs:"column",md:"row"}}}>
      ...
      >
        ...
        <EditorWrapper
          ...
          sx={{
            ...
            '& .rdw-editor-main': {
              px: '1.25rem',
              minHeight: { xs: 'auto',md: '17rem !important', lg: '12rem !important' }
            }
          }}
        >
          <ReactDraftWysiwyg
