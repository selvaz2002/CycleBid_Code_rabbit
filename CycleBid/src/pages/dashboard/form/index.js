...
import { Card, Grid, Button, Divider, MenuItem, TextField, CardHeader, InputLabel, IconButton, Typography, CardContent, CardActions, FormControl, OutlinedInput, InputAdornment, Select, Checkbox, FormGroup, FormControlLabel, Radio, RadioGroup } from '@mui/material'
...
const FormLayoutsSeparator = () => {
  ...
  return (
    <Card>
      <CardHeader title='Practice Form' />
      ...
      <form onSubmit={e => e.preventDefault()}>
        <CardContent>
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} sm={6}>
              <Typography variant='body2' sx={{ fontWeight: 600 }}>3.Check Box</Typography>
              <FormGroup row>
            ...
            <Grid item xs={12} sm={6}>
              <Typography variant='body2' sx={{ fontWeight: 600 }}>4.Radio Button</Typography>
